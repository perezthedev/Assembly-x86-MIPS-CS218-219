; Author: Ryan Aponte
; Section: 1004
; Date Last Modified: Sept. 4, 2020
...
;	4. quadAnswer4 = doubleVariable4	this should zero out upper rax
	mov eax, dword[doubleVariable4]
	mov qword[quadAnswer4], rax

;=====MOVSX=====
;	5. quadAnswer5 = doubleVariable5
	movsxd rbx, dword[doubleVariable5]
	mov qword[quadAnswer5], rbx
...
;	6. wordAnswer6 = wordVariable6a + wordVariable6b
	mov ax, word[wordVariable6b]
	add ax, word[wordVariable6a]
...
;	9. doubleAnswer9 = doubleVariable9 - wordVariable9
	movzx eax, word[wordVariable9]		; extend word to dword, to then sub as dword
	mov ebx, dword[doubleVariable9]		; needed register to store final num
	sub ebx, eax
...
;	15. wordAnswer15 = doubleVariable15 / wordVariable15
	...
	div word[wordVariable15]		; answer in ax
...
;	18. wordAnswer18 = (wordVariable18a x wordVariable18b) / wordVariable18c
	...
	imul word[wordVariable18b]	; answer is in dx:ax
...
;	      doubleRemainder19 = doubleVariable19a % doubleVariable19b
	...
	cdq
	idiv dword[doubleVariable19b]	; answer is in eax, rem in edx
...
;	20. doubleRemainder20 = quadVariable20 % doubleVariable20
	...
	idiv dword[doubleVariable20]	; result is in eax, rem in edx
